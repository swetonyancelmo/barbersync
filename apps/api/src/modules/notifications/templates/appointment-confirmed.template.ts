...
/** Monta a mensagem de confirmação de agendamento (assunto, HTML e texto). */
export function appointmentConfirmedMessage(
  ...
  const subject = `Agendamento confirmado — ${data.barbeariaNome}`;

  const text = [
    `Olá, ${primeiroNome}!`,
    ``,
    `Seu agendamento na ${data.barbeariaNome} foi CONFIRMADO. ✂️`,
    ``,
    `Serviço:  ${servicos}`,
    ...
    `Valor:    ${valor}`,
    ``,
    `Você receberá um lembrete perto do horário. Até lá!`,
  ...
  <div style="background:#0e0b07;padding:32px 16px;font-family:Helvetica,Arial,sans-serif;color:#efe7d6">
    <div style="max-width:480px;margin:0 auto;background:#1b1510;border:1px solid #3a2e1f;border-radius:4px;overflow:hidden">
      ...
      <div style="padding:28px 26px">
        ...
        <h1 style="margin:0 0 6px;font-family:Georgia,serif;font-size:24px;color:#efe7d6">Agendamento confirmado!</h1>
        <p style="margin:0 0 20px;color:#9a8e79;font-size:15px">Olá, ${primeiroNome} — está tudo certo para o seu corte. ✂️</p>
        ...
        <p style="margin:22px 0 0;color:#9a8e79;font-size:13px">Você receberá um lembrete perto do horário. Até lá!</p>
      </div>
    </div>
